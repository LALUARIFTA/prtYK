...
// Fetch public data (Prioritize Supabase)
...
$skills = sb_get('skills', 'id.asc');
$partners = sb_get('partners', 'id.asc');
$testimonials_db = sb_get('testimonials', 'id.desc');

// Chatbot knowledge bridge
$knowledge_data = sb_get('chatbot_knowledge', 'keyword.asc');
$knowledge_raw = [];
if ($knowledge_data) {
    foreach ($knowledge_data as $k) {
        $knowledge_raw[$k['keyword']] = $k['response'];
    }
}
?>
<script>
    ...
    <main class="container">
        ...
        <?php if (!empty($certificates)): ?>
            <section class="design-slider-section reveal" data-category="certificate"
                ...
                <?php
                // Fixed certificate counts for specified platforms
                $camy_count = 12;
                $dicoding_count = 90;
                $redhat_count = 2;
                $mbkm_count = 2;
                ...
                <div class="cert-grid-container reveal">
                            ...
                            <div class="cert-stat-content">
                                ...
                                <div class="cert-stat-front">
                                    <div class="cert-stat-back-content">
                                        <div class="platform-logo"><?php echo $stat['logo']; ?></div>
                                        <div class="cert-count-display">
                                            <span class="count-num"><?php echo $stat['count']; ?></span>
                                            <span class="count-label">Certificates</span>
                                        </div>
                                        <a href="<?php echo $stat['url']; ?>" target="_blank" class="visit-link">Visit
                                            Website</a>
                                    </div>
                                </div>

                                <!-- BACK (Decorative/Extra) -->
                                <div class="cert-stat-back">
                                    ...
                                    <div class="cert-stat-front-content">
                                        <div class="description">
                                            <div class="title">
                                                <p class="title"><strong><?php echo $stat['name']; ?></strong></p>
                                            </div>
                                            <p class="card-footer">Credential Verified</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="design-slider-item cert-item" data-title="<?php echo strtolower(h($c['title'])); ?>">
                                    <div class="cert-card-inner">
                                        <?php if (!empty($c['platform'])): ?>
                                            <div class="cert-badge"><?php echo h($c['platform']); ?></div>
                                        <?php endif; ?>
                                        ...
                                        <div class="cert-media-container">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo h($c['image_path']); ?>" alt="<?php echo h($c['title']); ?>"
                                                    loading="lazy">
                                            <?php endif; ?>
                                            <a href="<?php echo h($c['image_path']); ?>" target="_blank" class="cert-view-btn">VIEW
                                                DOCUMENT</a>
                                        </div>
            ...
            <div class="container">
                <div class="about-grid" style="margin-top: -2rem;">
                    <div class="about-img reveal">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 614 390" height="390"
                            width="614">
                            <g id="Frame">
                                <g id="box-figma">
                                    <path fill="#F9F9F9"
                                    ...
                                    <g id="box">
                                        ...
                                        <path stroke-width="2" stroke="#2563EB" fill="white"
                                            d="M592 301H582V311H592V301Z" id="figny9-adjust-4"></path>
        ...
        <section id="networking" class="section reveal" style="padding-top: 0; margin-top: -3rem;">
            <style>
                .cpu-anim-light {
                    offset-anchor: 10px 0px;
                    animation: animation-path-new infinite cubic-bezier(0.75, -0.01, 0, 0.99);
                }

                @keyframes animation-path-new {
                    0% {
                        offset-distance: 0%;
                    }
            ...
            <div class="outline-title">
                ...
                <svg class="dot-pattern">
                    <defs>
                        <pattern id="dots-networking" width="20" height="20" patternUnits="userSpaceOnUse">
                            <circle cx="2" cy="2" r="1" />
                        </pattern>
                    </defs>
                    <rect width="100%" height="100%" fill="url(#dots-networking)" />
                </svg>
            </div>

            <div class="container">
                <div class="about-grid" style="margin-top: -2rem; align-items: center;">
                    <!-- Left: CPU Architecture UI -->
                    <div class="about-img reveal active"
                        style="position: relative; display: flex; align-items: center;">
                        <svg width="100%" height="390" viewBox="0 0 200 100" class="text-muted">
                            <defs>
                                <radialGradient id="cpu-blue-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#00E8ED" />
                                    <stop offset="50%" stop-color="#08F" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-yellow-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#FFD800" />
                                    <stop offset="50%" stop-color="#FFD800" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-pinkish-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#830CD1" />
                                    <stop offset="50%" stop-color="#FF008B" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-white-grad-n" fx="1">
                                    <stop offset="0%" stop-color="white" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-green-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#22c55e" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-orange-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#f97316" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-cyan-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#06b6d4" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>
                                <radialGradient id="cpu-rose-grad-n" fx="1">
                                    <stop offset="0%" stop-color="#f43f5e" />
                                    <stop offset="100%" stop-color="transparent" />
                                </radialGradient>

                                <mask id="cpu-mask-1-n">
                                    <path d="M 10 20 h 79.5 q 5 0 5 5 v 24" stroke-width="0.5" stroke="white"
                                        fill="none" />
                                </mask>
                                <mask id="cpu-mask-2-n">
                                    <path d="M 180 10 h -69.7 q -5 0 -5 5 v 24" stroke-width="0.5" stroke="white"
                                        fill="none" />
                                </mask>
                                <mask id="cpu-mask-3-n">
                                    <path d="M 130 20 v 21.8 q 0 5 -5 5 h -10" stroke-width="0.5" stroke="white"
                                        fill="none" />
                                </mask>
                                <mask id="cpu-mask-4-n">
                                    <path d="M 170 80 v -21.8 q 0 -5 -5 -5 h -50" stroke-width="0.5" stroke="white"
                                        fill="none" />
                                </mask>
                                <mask id="cpu-mask-5-n">
                                    <path d="M 135 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20"
                                        stroke-width="0.5" stroke="white" fill="none" />
                                </mask>
                                <mask id="cpu-mask-6-n">
                                    <path d="M 94.8 95 v -36" stroke-width="0.5" stroke="white" fill="none" />
                                </mask>
                                <mask id="cpu-mask-7-n">
                                    <path d="M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14"
                                        stroke-width="0.5" stroke="white" fill="none" />
                                </mask>
                                <mask id="cpu-mask-8-n">
                                    <path d="M 30 30 h 25 q 5 0 5 5 v 6.5 q 0 5 5 5 h 20" stroke-width="0.5"
                                        stroke="white" fill="none" />
                                </mask>

                                <marker id="cpu-circle-marker-n" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="18"
                                    markerHeight="18">
                                    <circle id="innerMarkerCircle-n" cx="5" cy="5" r="2" fill="black" stroke="#232323"
                                        stroke-width="0.5">
                            ...
                            <!-- Data Paths -->
                            <g stroke="var(--border)" fill="none" stroke-width="0.3" opacity="0.8"
                                stroke-dasharray="100 100" pathLength="100" marker-start="url(#cpu-circle-marker-n)">
                                <path d="M 10 20 h 79.5 q 5 0 5 5 v 30" stroke-dasharray="100 100" pathLength="100" />
                                <path d="M 180 10 h -69.7 q -5 0 -5 5 v 40" stroke-dasharray="100 100"
                                    pathLength="100" />
                                <path d="M 130 20 v 21.8 q 0 5 -5 5 h -25" stroke-dasharray="100 100"
                                    pathLength="100" />
                                <path d="M 170 80 v -21.8 q 0 -5 -5 -5 h -65" stroke-dasharray="100 100"
                                    pathLength="100" />
                                <path d="M 135 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -35"
                                    stroke-dasharray="100 100" pathLength="100" />
                                <path d="M 94.8 95 v -46" stroke-dasharray="100 100" pathLength="100" />
                                <path d="M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 28"
                                    stroke-dasharray="100 100" pathLength="100" />
                                <path d="M 30 30 h 25 q 5 0 5 5 v 6.5 q 0 5 5 5 h 35" stroke-dasharray="100 100"
                                    pathLength="100" />
                            ...
                            <!-- Animated Lights -->
                            <g mask="url(#cpu-mask-1-n)">
                                <circle class="cpu-anim-light cpu-new-line-1" cx="0" cy="0" r="8"
                                    fill="url(#cpu-blue-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-2-n)">
                                <circle class="cpu-anim-light cpu-new-line-2" cx="0" cy="0" r="8"
                                    fill="url(#cpu-yellow-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-3-n)">
                                <circle class="cpu-anim-light cpu-new-line-3" cx="0" cy="0" r="8"
                                    fill="url(#cpu-pinkish-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-4-n)">
                                <circle class="cpu-anim-light cpu-new-line-4" cx="0" cy="0" r="8"
                                    fill="url(#cpu-white-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-5-n)">
                                <circle class="cpu-anim-light cpu-new-line-5" cx="0" cy="0" r="8"
                                    fill="url(#cpu-green-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-6-n)">
                                <circle class="cpu-anim-light cpu-new-line-6" cx="0" cy="0" r="8"
                                    fill="url(#cpu-orange-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-7-n)">
                                <circle class="cpu-anim-light cpu-new-line-7" cx="0" cy="0" r="8"
                                    fill="url(#cpu-cyan-grad-n)" />
                            </g>
                            <g mask="url(#cpu-mask-8-n)">
                                <circle class="cpu-anim-light cpu-new-line-8" cx="0" cy="0" r="8"
                                    fill="url(#cpu-rose-grad-n)" />
                            </g>
                    ...
                    <div class="about-text">
                        <div class="section-header" style="text-align: left;">
                            <h2 class="reveal"><span class="glitch-text" data-text="Networking">Networking</span> & IT
                                Support<br><span class="amber-text"></span></h2>
                            <p class="reveal staggered-text" style="margin-top: 1rem; opacity: 0.75; line-height: 1.8;">
                                <span>Menyediakan</span> solusi infrastruktur jaringan yang <span>andal</span> dan
                                layanan dukungan TI yang
                                <span>komprehensif</span>. Dari konfigurasi server, manajemen bandwidth, hingga
                                troubleshooting
                                perangkat keras, kami memastikan operasional digital Anda berjalan lancar tanpa hambatan
                            ...
                            <div class="reveal" style="margin-top: 2rem;">
                                <p
                                    ...
                                    HOVER TO DECODE</p>
                                <div class="text-scramble-wrapper">
                                    <span class="scramble-text" data-scramble>SYSTEM STATUS: OPTIMIZED</span>
                                    <div class="scramble-underline">
                                        <div class="scramble-underline-fill"></div>
                                    </div>
                                    <div class="scramble-glow"></div>
        ...
        <!-- Contact Section -->
        <section id="contact" class="section reveal" style="margin-top: -3rem; padding-top: 0;">
            <div class="outline-title">
                CONTACT
                <svg class="dot-pattern">
                    <defs>
            ...
            <div class="container">
                <div class="about-grid" style="margin-top: -2rem; align-items: flex-start;">
                        ...
                        <div class="reveal-container reveal" id="contactReveal"
                            ...
                            if (!function_exists('renderReveal')) {
                                function renderReveal($text, $baseDelay = 0)
                                {
                                    ...
                                    echo '<div class="reveal-line" style="justify-content: flex-end;">';
                            ...
                            ?>
                            <p class="reveal-subtext" style="text-align: right; margin-left: auto;">Let's build the
                                future of your digital presence with cutting-edge
                                solutions and premium craftsmanship.</p>
                        </div>
                    </div>

                    <!-- Right: Social Media & Location -->
                    <div class="contact-right-side"
                        style="flex: 1; display: flex; flex-direction: column; gap: 2rem; align-items: flex-start;">

                        <!-- Location Preview (Right Side) -->
                        <div class="reveal location-preview-container"
                            style="width: 100%; max-width: 450px; margin-top: 0;">
                            <div class="location-map-frame">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3944.257321685834!2d116.12170907501438!3d-8.686448991361955!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOMKwNDEnMTEuMiJTIDExNiwwNycyNy40IkU!5e0!3m2!1sen!2sid!4v1713936000000!5m2!1sen!2sid"
                        ...
                        <div class="social-container reveal" style="margin-top: 0;">
                            <div class="reveal" style="margin-bottom: 1.5rem;">
                                <p
                                    style="text-shadow: none; font-size: 0.6rem; letter-spacing: 0.4em; color: var(--primary); margin-bottom: 0.5rem; border: none; padding: 0;">
                                    HOVER TO DECODE</p>
                                <div class="text-scramble-wrapper">
                                    <span class="scramble-text" data-scramble>CONNECT WITH ME</span>
                                    <div class="scramble-underline">
                                        <div class="scramble-underline-fill"></div>
                                    </div>
                                    <div class="scramble-glow"></div>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative flex items-center gap-x-2 p-2">
                                    <!-- LinkedIn -->
                                    <a href="https://www.linkedin.com/in/lalu-arif/" target="_blank"
                                    ...
                                    <!-- Instagram -->
                                    <a href="https://www.instagram.com/ashari.ll/" target="_blank"
                                        class="relative block">
                                        <div style="clip-path: url(#squircleClip)"
                                    ...
                                    <!-- Dicoding -->
                                    <a href="https://www.dicoding.com/users/laluarifta/academies" target="_blank"
                                        class="relative block">
                                        <div style="clip-path: url(#squircleClip)"
                                            class="w-14 h-14 bg-gradient-to-br from-gray-700 to-gray-900 rounded-xl flex items-center justify-center shadow-lg border border-gray-500/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl">
                                            <span class="text-white font-bold text-xl">DC</span>
                                        </div>
                                    </a>

                                    <!-- Camy.id -->
                                    <a href="https://camy.id/" target="_blank" class="relative block">
                                        <div style="clip-path: url(#squircleClip)"
                                            class="w-14 h-14 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center shadow-lg border border-orange-400/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl">
        ...
        <!-- Payment Methods UI -->
        <div class="payment-section reveal section" style="padding-top: 2rem; margin-top: 0rem; border: none;">
            <div class="container">
                <div class="about-grid" style="margin-top: 2rem; align-items: center;">
                    <!-- Marketing Text -->
                    <div class="payment-text-block" style="text-align: right; margin-left: auto;">
                        <h2 style="color: white;">Terintegrasi Ekosistem<span> </span></h2>
                        <p>Hubungkan website Anda dengan berbagai vendor dan payment gateway terpercaya di Indonesia.
                        </p>

                        <?php if (!empty($partners)): ?>
                            <div class="partners-container"
                                style="margin-top: 2rem; width: 100%; display: flex; flex-direction: column; align-items: flex-end;">
                                <h4
                                ...
                                <div class="partners-marquee-container"
                                    ...
                                    <div class="partners-marquee-inner" style="justify-content: flex-end;">
                                        <?php
                        ...
                        <div class="pocket">
                            ...
                            <div class="pocket-content">
                                ...
                                <div class="eye-icon-wrapper">
                                    <svg class="eye-icon eye-slash" width="20" height="20" viewBox="0 0 24 24"
